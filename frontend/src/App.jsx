          ...
          <section className="landing-hero">
            ...
            <div className="hero-readout" id="recommendations">
              <div className="readout-content">
                ...
                <div className={`readout-main ${readoutLoading ? 'is-loading' : 'is-ready'}`}><span>Protected monthly savings</span><strong className="readout-price saved-price" aria-live="polite">{readoutLoading ? <span className="price-skeleton-bar" aria-label="Calculating savings" /> : totalPotentialSavings > 0 ? `−${formatCurrency(totalPotentialSavings)}` : formatCurrency(0)}</strong><p>{readoutLoading ? 'Analyzing telemetry and surge context' : 'With DeMarcate'}</p></div>
